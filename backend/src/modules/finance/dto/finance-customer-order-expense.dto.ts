...
export class CreateCustomerOrderExpenseDto {
  ...
  @ApiPropertyOptional({ description: 'Optional link to the CustomerOrderDocument that confirms this expense — must belong to the same customer order.' })
  @IsOptional()
  @IsUUID()
  documentId?: string;
}

export class UpdateCustomerOrderExpenseDto {
