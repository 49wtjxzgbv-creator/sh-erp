...
/**
 * "Чи додаємо ці підвироби в замовлення" (2026-08-25, restored 2026-08-27
 ...
 * user picks "Виготовити" (plans a PLANNED ProductionOrder batch now,
 * linked via subAssemblyForItemId once the order is created) or "Зі
 * складу" (do nothing — same as today's implicit default, consumed from
 * whatever's IN_STOCK once the parent assembly is actually started).
 */
