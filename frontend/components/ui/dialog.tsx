...
const dialogContentVariants = cva(
  'fixed left-1/2 top-1/2 z-50 w-[calc(100vw-2rem)] -translate-x-1/2 -translate-y-1/2 rounded-lg border border-border bg-card p-6 shadow-lg max-h-[85vh] overflow-y-auto',
  {
    variants: {
      size: {
        sm: 'max-w-sm',
